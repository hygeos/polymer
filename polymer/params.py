...
class Params(object):
    ...
    def defaults_hypso(self):
        # hypso_bands = [
        #     379, 383, 386, 390, 393, 397, 401, 404, 408, 411, 415, 418, 422, 425,
        #     429, 432, 436, 439, 443, 446, 450, 453, 457, 460, 464, 467, 471, 474,
        #     478, 481, 485, 488, 492, 495, 499, 502, 506, 509, 513, 516, 520, 523,
        #     526, 530, 533, 537, 540, 544, 547, 551, 554, 558, 561, 565, 568, 572,
        #     575, 579, 582, 585, 589, 592, 596, 599, 603, 606, 610, 613, 617, 620,
        #     623, 627, 630, 634, 637, 641, 644, 648, 651, 654, 658, 661, 665, 668,
        #     672, 675, 678, 682, 685, 689, 692, 696, 699, 702, 706, 709, 713, 716,
        #     719, 723, 726, 730, 733, 737, 740, 743, 747, 750, 754, 757, 760, 764,
        #     767, 771, 774, 777, 781, 784, 787, 791]
        hypso_bands_rw = [
                                        401, 404, 408, 411, 415, 418, 422, 425,
            429, 432, 436, 439, 443, 446, 450, 453, 457, 460, 464, 467, 471, 474,
            478, 481, 485, 488, 492, 495, 499, 502, 506, 509, 513, 516, 520, 523,
            526, 530, 533, 537, 540, 544, 547, 551, 554, 558, 561, 565, 568, 572,
            575, 579, 582, 585, 589, 592, 596, 599, 603, 606, 610, 613, 617, 620,
        ...
        hypso_bands_corr = [
                                        ...
                                        450, 453, 457, 460, 464, 467, 471, 474,
            478, 481, 485, 488, 492, 495, 499, 502, 506, 509, 513, 516, 520, 523,
            526, 530, 533, 537, 540, 544, 547, 551, 554, 558, 561, 565, 568, 572,
            575, 579, 582, 585, 589, 592, 596, 599, 603, 606, 610, 613, 617, 620,
            623, 627, 630, 634, 637, 641, 644, 648, 651, 654, 658, 661,
            
            
                                781, 784, 787, 791]
        self.bands_corr = hypso_bands_corr
        self.bands_oc = hypso_bands_corr
        self.bands_rw = hypso_bands_rw
        self.band_cloudmask = 791
        self.gsw_agg = 8
        self.calib = None
