...
class Params(object):
    ...
    def sensor_specific(self, sensor):
        ...
        #     self.defaults_olci()
            ...
            self.defaults_viirsj2()
        # elif sensor == 'MODIS':
        #     self.defaults_modis()
        elif sensor == 'MODISA':
            self.defaults_modisa()
        elif sensor == 'MODIST':
            self.defaults_modist()
        elif sensor == 'SeaWiFS':
    ...
    def defaults_olcia(self):
        '''
        define default parameters for Sentinel-3/OLCI-A
        '''
        ...
        self.band_cloudmask = 865
        # SAME VSC FOR OLCI-A AND OLCI-B
        self.calib = {  # SVC 01/08/19
            400 : 1.000000, 412 : 1.000000,
            443 : 0.999210, 490 : 0.984674,
            510 : 0.986406, 560 : 0.988970,
        ...
        self.K_OZ = {
                400 : 2.243E-06, 412 : 2.245E-04,
                443 : 3.058E-03, 490 : 2.072E-02,
                510 : 4.131E-02, 560 : 1.066E-01,
                620 : 1.079E-01, 665 : 4.978E-02,
                674 : 4.068E-02, 681 : 3.487E-02,
                709 : 1.879E-02, 754 : 8.558E-03,
                760 : 6.764E-03, 764 : 6.895E-03,
                767 : 6.754E-03, 779 : 7.674E-03,
                865 : 2.090E-03, 885 : 1.204E-03,
                900 : 1.533E-03, 940 : 7.002E-04,
                1020: 8.556E-05,
                }

        # from https://oceancolor.gsfc.nasa.gov/resources/docs/rsr_tables/
        self.K_NO2 = {
                400 : 6.188E-19, 412 : 6.097E-19,
                443 : 4.956E-19, 490 : 2.936E-19,
                510 : 2.169E-19, 560 : 7.444E-20,
                620 : 2.781E-20, 665 : 6.744E-21,
                674 : 1.008E-20, 681 : 6.154E-21,
                709 : 4.947E-21, 754 : 1.362E-21,
                760 : 4.510E-22, 764 : 6.446E-22,
                767 : 4.920E-22, 779 : 3.786E-22,
                865 : 2.690E-23, 885 : 4.338E-23,
                900 : 5.291E-23, 940 : 4.464E-24,
                1020: 0.000E+00,
                }


    def defaults_olcib(self):
        '''
        define default parameters for Sentinel-3/OLCI-B
        '''
        ...
        # from https://oceancolor.gsfc.nasa.gov/resources/docs/rsr_tables/
        self.K_OZ = {
                400 : 2.121E-06, 412 : 2.280E-04,
                443 : 3.063E-03, 490 : 2.068E-02,
                510 : 4.130E-02, 560 : 1.064E-01,
                620 : 1.081E-01, 665 : 4.993E-02,
                674 : 4.082E-02, 681 : 3.498E-02,
                709 : 1.882E-02, 754 : 8.624E-03,
                760 : 6.740E-03, 764 : 6.904E-03,
                767 : 6.752E-03, 779 : 7.685E-03,
                865 : 2.110E-03, 885 : 1.199E-03,
                900 : 1.537E-03, 940 : 6.977E-04,
                1020: 8.588E-05,
                }

        # from https://oceancolor.gsfc.nasa.gov/resources/docs/rsr_tables/
        self.K_NO2 = {
                400 : 6.184E-19, 412 : 6.089E-19,
                443 : 4.963E-19, 490 : 2.933E-19,
                510 : 2.176E-19, 560 : 7.427E-20,
                620 : 2.795E-20, 665 : 6.685E-21,
                674 : 1.012E-20, 681 : 6.230E-21,
                709 : 4.950E-21, 754 : 1.371E-21,
                760 : 4.456E-22, 764 : 6.409E-22,
                767 : 5.021E-22, 779 : 3.752E-22,
                865 : 2.742E-23, 885 : 4.292E-23,
                900 : 5.230E-23, 940 : 4.703E-24,
                1020: 0.000E+00,
                }
    ...
    def defaults_modisa(self):
        self.bands_corr = [412,443,    488,531,547,        667,678,748,    869,    ]
        self.bands_oc   = [412,443,    488,531,547,        667,678,748,    869,    ]
        self.bands_rw   = [412,443,    488,531,547,        667,678,748,    869,    ]

        self.band_cloudmask = 869
        # SAME VSC FOR MODISA AND MODIST
        self.calib = { # OC-CCI SVC 20190425 (ERA) for NASA R2018 (L1C generated with g=1)
            412: 0.998926, 443: 1.002921,
            488: 0.998408, 531: 0.998077,
            547: 0.997570, 667: 1.000000,
